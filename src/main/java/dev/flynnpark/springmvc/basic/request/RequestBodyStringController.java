...
public class RequestBodyStringController {
    ...
    /**
     * InputStream(Reader): HTTP 요청 메세지 바디의 내용을 직접 조회<br>
     ...
     * - 메세지 바디 정보를 직접 조회(@RequestParam X, @ModelAttribute X)<br>
     * - HttpMessageConverter 사용 -> StringHttpMessageConverter 적용<br>
     * <br>
     * 응답에서도 HttpEntity 사용 가능<br>
     * - 메세지 바디 정보 직접 반환(view 조회 X)<br>
     * - HttpMessageConverter 사용 -> StringHttpMessageConverter 적용
     */
    @PostMapping("/request-body-v3")
    public HttpEntity<String> reuqestBodyStringV3(HttpEntity<String> httpEntity) {
     ...
     * <br>
     * @ResponseBody<br>
     * - 메세지 바디 정보 직접 반환(view 조회하지 않음)<br>
     * - HttpMessageConverter 사용 -> StringHttpMessageConverter 적용
     */
    @ResponseBody
